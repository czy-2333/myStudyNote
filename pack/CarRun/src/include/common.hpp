...
#define PWMSERVOMAX 1950 // 舵机PWM最大值（左）1950
#define PWMSERVOMID 1500 // 舵机PWM中值 1500
#define PWMSERVOMIN 1050 // 舵机PWM最小值（右）1050
...
#define LABEL_EVIL "evil"      // AI标签：恐怖分子
#define LABEL_BLOCK "block"     // AI标签：障碍物
#define LABEL_PATIENT "patient"   // AI标签：伤员
#define LABEL_PROP "prop"      // AI标签：道具车
#define LABEL_SPY "spy"      // AI标签：嫌疑车辆
#define LABEL_THIEF "thief"    // AI标签：盗贼
#define LABEL_TUMBLE "tumble"   // AI标签：跌倒
